    ...
    methods: {
      init ()
      {
        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.id) {
            this.$http({
              url: this.$http.adornUrl(`/house/business/result/select`),
              method: 'get',
      ...
      loadRecordList () {
        this.$http({
          url: this.$http.adornUrl(`/house/business/record/data`),
          method: 'get',
          params: this.$http.adornParams({
            'house_id': this.dataForm.id
          })
      ...
      dataFormSubmit () {
        this.$refs['dataForm'].validate((valid) => {
          if (valid) {
            this.$http({
              url: this.$http.adornUrl(`/house/business/result/handle`),
              method: 'post',
